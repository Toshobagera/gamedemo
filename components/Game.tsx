...
import { Tower, Enemy, Projectile, TowerType, Wave, Effect, Vector2D, DamageType } from '../types';
import { GAME_WIDTH, GAME_HEIGHT, ENEMY_STATS, TOWER_STATS, TILE_SIZE, getStageData, TOWER_PRICE_INCREASE_RATE, TOWER_SELL_RATIO, BOSS_DEFINITIONS } from '../constants';
    ...
    if (gameState === 'wave_countdown') {
      return (
        <button onClick={handleEarlyStart} className="px-6 py-3 bg-cyan-500 text-white font-bold rounded-lg shadow-lg hover:bg-cyan-600 transition-all duration-200 transform hover:scale-105">
          {t('start_early', waveStartCountdown)}
